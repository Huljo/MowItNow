...
Move.prototype.goForward = function() {
    ...
    var grid = this.grid;
    var newPosition = _.clone(mower.position);
...
Move.prototype.turn = function(instruction) {
    var mower = this.mower;
    var newPosition = _.clone(mower.position);
    var cardinalIndex = _.findIndex(cardinalPoints, function(c) { return c === mower.position.c });
    var newCardinalIndex = cardinalIndex;
    switch(instruction) {
        case 'D':
